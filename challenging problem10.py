...
print("학급의 평균 점수는 {}입니다.".format(students.get_average()))
print("가장 성적이 높은 학생은 {}입니다.".format(students.get_first_by_score().name))
print("가장 성적이 낮은 학생은 {}입니다.".format(students.get_last_by_score().name))